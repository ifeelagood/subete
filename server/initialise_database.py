...
def init_tables(cursor, conn):
    ...
    cursor.execute('CREATE TABLE IF NOT EXISTS students (id INTEGER PRIMARY KEY, class_id INTEGER, first_name TEXT, last_name TEXT, password TEXT, salt TEXT, created_at INTEGER)')
